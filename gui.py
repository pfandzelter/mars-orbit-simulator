...
# red, black text
STYLE_1 = (
    "QPushButton {background-color: rgba(255, 50, 50, 10); color: rgba(0,0,0,255);}"
)

# green, black text
STYLE_2 = (
    "QPushButton {background-color: rgba(50, 255, 50, 10); color: rgba(0,0,0,255);}"
)
...
class ApplicationWindow(QWidget):
    ...
    def makeControls(self):
        ...
        self.importGMLButton.setToolTip(
            "spawn a new simulation process from a GML file"
        )
        ...
        self.saveImagesCheckbox.setToolTip(
            "check this box to begin saving images\npath: ./pics"
        )
        ...
        self.saveGMLSCheckbox.setToolTip(
            "check this box to begin saving GML files\npath: ./gmls"
        )
    ...
    def latLonToXYZ(self, lat, lon):
        ...
        x = MARS_RADIUS * math.cos(lat) * math.cos(lon)
        y = MARS_RADIUS * math.cos(lat) * math.sin(lon)
        z = MARS_RADIUS * math.sin(lat)
        return [x, y, z]
